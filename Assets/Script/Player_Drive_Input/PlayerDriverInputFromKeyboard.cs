...
public class PlayerDriverInputFromKeyboard : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        SteerObject.maxAngle = 270;
        SteerObject.minAngle = -270;
    ...
    void Update()
    {
        ...
        //if (!transform.GetComponent<PlayerDriveInputFromLogitech>().enabled)
        //{
        //    CarInput(true);
        //    UpdateSteerObject();
        //}
    ...
    private void CarInput(bool showMess = false)
    {
        ...
        if (gear > 0 || accel > 0) accel = Mathf.Clamp(accel, 0.12f, 1);
